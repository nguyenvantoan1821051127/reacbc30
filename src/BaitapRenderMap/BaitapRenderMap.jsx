...
export default class BaitapRenderMap extends Component {
    renderFimMap=()=>{
        return data.map((fim,index)=>{
            return <div className="col-2"key={index}>
                <div className="item p-2">
                    <div className="fim">
                        <img src={fim.hinhAnh}alt='...'width={100} />
    ...
    return (
      <div className='content '>
        <div style={{minHeight:'100vh',background:'rgba(0,0,0,0.5)'}}>
            <nav className="navbar navbar-expand-sm  bg-primary"style={{background:'rgba(0,0,0,0.1)'}}>
                        ...
                        return <div className="col-3 mt-2"key={index}>
                            <div className="card">
                                ...
                                <div className="card-body bg-dark text-white">
                                    <h3 style={{height:'75'}}>{prod.tenPhim}</h3>
                                    <p style={{height:'100'}}>{prod.moTa.length>100 ? prod.moTa.substr(0,100)+'...':prod.moTa}</p> 
                                </div>
                            </div>
                        </div>
                    })]}
